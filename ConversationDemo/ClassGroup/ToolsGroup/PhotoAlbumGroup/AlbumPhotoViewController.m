...
- (UICollectionView *)collectionView{
    if (_collectionView == nil){
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(UIScreen.mainScreen.bounds), getPageSafeAreaHeight(YES)) collectionViewLayout:layout];
