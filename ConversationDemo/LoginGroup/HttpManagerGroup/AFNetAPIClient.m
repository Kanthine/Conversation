...
+(AFNetAPIClient*)sharedClient
{
    ...
    dispatch_once(&onceToken, ^{
       ...
       */
      _sharedClient.completionQueue = dispatch_queue_create("com.objective_c_language.gcd.httpCompletionHandleDataQueue", DISPATCH_QUEUE_CONCURRENT);
...
-(NSURLSessionDataTask *)requestForGetUrl:(NSString*)url success:(void (^)(id responseObject))success failure:(void (^)(NSError *error))failure
{
    ...
    if (UserManager.shareUser.account){
        /*
