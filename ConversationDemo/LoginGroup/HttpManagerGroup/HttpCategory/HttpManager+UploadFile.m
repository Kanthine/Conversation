...
+ (void)upLoadImage:(UIImage *)image
{
    ...
    [AFNetAPIClient.sharedClient POST:URL_Update_Header parameters:nil headers:nil constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
...
{
    [AFNetAPIClient.sharedClient POST:URL_File_Upload parameters:nil headers:nil constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
        // FileURL 文件地址  name 参数名称  fileName 文件名称  mimeType 文件类型
