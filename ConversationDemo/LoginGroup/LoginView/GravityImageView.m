...
@implementation GravityImageView
...
-(void)startAnimate
{
    ...
    [GravityInduction sharedGravity].timeInterval = 0.01;
    
    [[GravityInduction sharedGravity]startDeviceMotionUpdatesBlock:^(float x, float y, float z) {
...
-(void)stopAnimate
{
    [[GravityInduction sharedGravity] stop];
}
