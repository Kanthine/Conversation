...
+ (void)requestLibraryAuthorization{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"App需要你的同意,访问相册,选择照片发布菜品评价、设置头像" message:nil preferredStyle:UIAlertControllerStyleAlert];
    ...
    [NSObject.getCurrentViewController presentViewController:alertController animated:YES completion:nil];
}
...
+ (void)requestCameraAuthorization{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"App需要你的同意,访问相机,拍摄照片发布菜品评价、设置头像" message:nil preferredStyle:UIAlertControllerStyleAlert];
